	...
	public static SessionFactory getSessionFactory() {
		if (sessionFactory == null) {
			try {
				...
				LOG.info("database properties : urldev"+reader.getProperty("db.urlDev"));
				...
				// if (!dbUrlProdurl.isBlank() && dbUrlProdurl != null && !securityDbUser.isBlank() && securityDbUser != null  && !securityDbPwd.isBlank() && securityDbPwd != null) {
				// 	LOG.info("shui la ");
